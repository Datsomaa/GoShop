        ...
        newSp.innerHTML = `
          <div class="row mb-4 d-flex justify-content-between align-items-center pb-4 border-bottom">
            <div class="col-4 col-xl-2 px-0 px-sm-2">
              <img
                src="../assets/images/sp/${sp[id].url}.jpg"
                class="img-fluid rounded-3" alt="spsp">
            </div>
            <div class="row col-6 col-xl-9">
              <div class="col-xl-4">
                <h6 class="text-black mb-0 mb-xl-1">${sp[id].name}</h6>
              </div>
              ...
              <div class="col-xl-4 d-flex align-items-center">
                <h6 class="mb-0">${sp[id].price}.000₫</h6>
              </div>
            </div>
